//! Responsibility: encode terminal mouse events into escape sequences.
//! Ownership: input mouse encoding authority.
//! Reason: keep mouse protocol encoding separate from keyboard encoding and host token parsing.
