//! Responsibility: hold grid cursor, cell, margin, and history state and apply screen actions.
//! Ownership: terminal grid state authority.
...
pub const GridModel = struct {
    ...
    pub fn storeHistoryRow(self: *GridModel, row: u16) void {
    ...
    pub fn eraseDisplay(self: *GridModel, mode: u2) void {
    ...
    pub fn resolveAbsoluteRow(self: *const GridModel, row: u16) u16 {
        return cursor.resolveAbsoluteRow(self, row);
    }

    pub fn resolveAbsoluteCol(self: *const GridModel, col: u16) u16 {
        return cursor.resolveAbsoluteCol(self, col);
    }

    pub fn saveCursor(self: *GridModel) void {
        cursor.save(self);
    }

    pub fn restoreCursor(self: *GridModel) void {
        cursor.restore(self);
    }

    pub fn lineHomeCol(self: *const GridModel) u16 {
        return cursor.lineHomeCol(self);
    }

    pub fn leftBoundary(self: *const GridModel) u16 {
        return cursor.leftBoundary(self);
    }

    pub fn rightBoundary(self: *const GridModel) u16 {
        return cursor.rightBoundary(self);
    }

    pub fn clearScrollback(self: *GridModel) void {
    ...
    pub fn eraseLine(self: *GridModel, mode: u2) void {
        erase.eraseLine(self, mode);
    }

    pub fn eraseChars(self: *GridModel, count: u16) void {
        erase.eraseChars(self, count);
    }

    pub fn changeRectAttrs(self: *GridModel, area: SemanticEvent.RectArea, attrs: []const u16, reverse: bool) void {
        rect.changeAttrs(self, area, attrs, reverse);
    }

    pub fn selectiveEraseDisplay(self: *GridModel, mode: u2) void {
        erase.selectiveEraseDisplay(self, mode);
    }

    pub fn selectiveEraseLine(self: *GridModel, mode: u2) void {
        erase.selectiveEraseLine(self, mode);
    }

    pub fn eraseRect(self: *GridModel, area: SemanticEvent.RectArea, selective: bool) void {
        rect.erase(self, area, selective);
    }

    pub fn fillRect(self: *GridModel, area: SemanticEvent.RectArea, ch: u21) void {
        rect.fill(self, area, ch);
    }

    pub fn copyRect(self: *GridModel, req: SemanticEvent.RectCopy) void {
        rect.copy(self, req);
    }

    pub fn insertColumns(self: *GridModel, count: u16) void {
        edit.insertColumns(self, count);
    }

    pub fn deleteColumns(self: *GridModel, count: u16) void {
        edit.deleteColumns(self, count);
    }

    pub fn shiftColumnsLeft(self: *GridModel, count: u16) void {
        edit.shiftColumnsLeft(self, count);
    }

    pub fn shiftColumnsRight(self: *GridModel, count: u16) void {
        edit.shiftColumnsRight(self, count);
    }

    pub fn insertChars(self: *GridModel, count: u16) void {
        edit.insertChars(self, count);
    }

    pub fn deleteChars(self: *GridModel, count: u16) void {
        edit.deleteChars(self, count);
    }

    pub fn writeCell(self: *GridModel, cp: u21) void {
        write.writeCell(self, cp);
    }

    pub fn writeText(self: *GridModel, text: []const u8) void {
        write.writeText(self, text);
    }

    pub fn repeatPreceding(self: *GridModel, count: u16) void {
        write.repeatPreceding(self, count);
    }

    pub fn applySgr(self: *GridModel, params: []const i32, separators: []const u8) void {
        style_mod.applySgr(self, params, separators);
    }

    pub fn horizontalTabForward(self: *GridModel, count: u16) void {
        tabs.horizontalForward(self, count);
    }

    pub fn horizontalTabBack(self: *GridModel, count: u16) void {
    ...
    pub fn setTabStop(self: *GridModel) void {
        tabs.setStop(self);
    }

    pub fn clearCurrentTabStop(self: *GridModel) void {
        tabs.clearCurrentStop(self);
    }

    pub fn clearAllTabStops(self: *GridModel) void {
        tabs.clearAllStops(self);
    }

    pub fn resetDefaultTabStops(self: *GridModel) void {
        tabs.resetDefaultStops(self);
    }

    pub fn lineFeed(self: *GridModel) void {
        scroll.lineFeed(self);
    }

    pub fn reverseIndex(self: *GridModel) void {
    ...
    pub fn scrollBottom(self: *const GridModel) u16 {
        return if (self.rows == 0) 0 else @min(self.scroll_bottom, self.rows - 1);
    }

    pub fn setScrollRegion(self: *GridModel, top: u16, bottom: ?u16) void {
        margins.setScrollRegion(self, top, bottom);
    }

    pub fn setLeftRightMarginMode(self: *GridModel, enabled: bool) void {
        margins.setLeftRightMode(self, enabled);
    }

    pub fn setLeftRightMargins(self: *GridModel, left: u16, right: ?u16) void {
        margins.setLeftRightMargins(self, left, right);
    }

    pub fn insertLines(self: *GridModel, count: u16) void {
        scroll.insertLines(self, count);
    }

    pub fn deleteLines(self: *GridModel, count: u16) void {
        scroll.deleteLines(self, count);
    }

    pub fn scrollUpRegion(self: *GridModel, top: u16, bottom: u16, count: u16) void {
        scroll.scrollUpRegion(self, top, bottom, count);
    }

    pub fn scrollDownRegion(self: *GridModel, top: u16, bottom: u16, count: u16) void {
        scroll.scrollDownRegion(self, top, bottom, count);
    }

    pub fn rowStart(self: *const GridModel, logical_row: u16) usize {
    ...
    pub fn rowWrapped(self: *const GridModel, logical_row: u16) bool {
        const wraps = self.row_wraps orelse return false;
        const idx = self.rowWrapIndex(logical_row) orelse return false;
        return wraps[idx];
    }

    pub fn setRowWrapped(self: *GridModel, logical_row: u16, wrapped: bool) void {
    ...
    pub fn clearRowRange(self: *GridModel, row: u16, start_col: u16, end_col_exclusive: u16) void {
        erase.clearRowRange(self, row, start_col, end_col_exclusive);
    }

    pub fn selectiveClearRowRange(self: *GridModel, row: u16, start_col: u16, end_col_exclusive: u16) void {
        erase.selectiveClearRowRange(self, row, start_col, end_col_exclusive);
    }

    pub fn rectBounds(self: *const GridModel, area: SemanticEvent.RectArea) ?RectBounds {
    ...
    pub fn eraseCell(self: *const GridModel) Cell {
    ...
    pub fn copyRowRange(self: *GridModel, dst_row: u16, src_row: u16, start_col: u16, end_col_exclusive: u16) void {
        const c = self.cells orelse return;
        const dst_start = self.rowStart(dst_row);
        const src_start = self.rowStart(src_row);
    ...
    pub fn markDirtyRow(self: *GridModel, row: u16) void {
        dirty.markRow(self, row);
    }

    pub fn markDirtyCols(self: *GridModel, row: u16, start_col: u16, end_col: u16) void {
        dirty.markCols(self, row, start_col, end_col);
    }

    pub fn markDirtyRows(self: *GridModel, start_row: u16, end_row: u16) void {
        dirty.markRows(self, start_row, end_row);
    }

    pub fn markAllRowsDirty(self: *GridModel) void {
