...
fn appendReport(state: *Locator.State, allocator: std.mem.Allocator, output: *std.ArrayList(u8), encode_buf: []u8, event_code: u16, buttons_down: u8, row: u16, col: u16) void {
...
fn coordinates(state: *const Locator.State, row: u16, col: u16) struct { row: u32, col: u32 } {
